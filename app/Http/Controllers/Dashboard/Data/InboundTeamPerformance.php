...
trait InboundTeamPerformance
{
     public function kpiTicketStatus2(Request $request, DashboardTicketService $dashboardTicketService)
     {
         $user = user();
            // $currentDate = now();
    ...
    //  }
     ...
     public function kpiWebCall2(Request $request, DashboardTicketService $dashboardTicketService)
     {
          $user = user();
          $currentDate = now();
          $dates = Yellow::getDateRangeByPeriod($currentDate, $request->get('periode', 'today'));
     ...
     public function kpiCsat2(Request $request, DashboardTicketService $dashboardTicketService)
     {
          $user = user();
          $currentDate = now();
          $dates = Yellow::getDateRangeByPeriod($currentDate, $request->get('periode', 'today'));
     ...
     public function kpiTicketStatusChart2(Request $request, DashboardTicketService $dashboardTicketService)
     {
          $colors  = [
               "New" => "#FF605C",
               "Open" => "#FFBD44",

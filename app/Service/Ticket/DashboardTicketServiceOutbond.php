     ...
     public function findTopSolvedClosedTicketAgent($user, $dates, $type, $top = 10, $filter = [])
     {
          ...
          $result = $this->model::query()
               ...
               ->where(function ($query) {
                    ...
                    $query->whereNotNull('company_users.name');
               })
     ...
     public function findAllDailyTicketCategory($user, $dates, $type)
     {
          ...
          $result = $this->model::query()
               ...
               ->selectRaw("
                    ...
                    sum(case when (st.status_category is null and tickets.status!='Auto Closed') or st.status_category='New' then 1 else 0 end) as new,
